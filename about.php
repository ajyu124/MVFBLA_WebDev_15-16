...
<header class="window half" id="windowAbout">
	<div class="container">
		<h2 class="animated fadeInDown">About Panettiere</h2>
		<p class="animated fadeInUp">Learn more about our passion and why we do what we do</p>
	</div>
</header>
<div class="container">
	<div class="row">
		<div class="columns twelve">
			<h4>Our mission</h4>
			<img src="/images/features/about_1.png" class="img right hidesmall">
			<br class="hidesmall"><br class="hidesmall">
			<p>As a modern-day bakery and restaurant, we strive to provide quality, healthy, and wholesome food for everyone. Finding a reliable source of gluten-free foods, let alone cooking completely gluten-free, can be extremely tough. As experts in the food industry, we know that maintaining a gluten-free lifestyle is challenging. That’s why we founded Panettiere (Italian for "baker") Bakery &amp; Restaurant to provide both delicious food and inspiration to all.</p>
			<br class="hidesmall"><br class="hidesmall">
