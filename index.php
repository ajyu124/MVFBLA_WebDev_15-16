...
<header class="window" id="windowHome">
	<div class="container">
		<h2 class="animated long fadeInLeft">Panettiere</h2>
		<p class="animated long fadeInRight">A modern bakery and restaurant with hearty, gluten-free food for everyone</p>
	</div>
</header>
<div class="container">
	<div class="row">
	...
	<div class="row">
		<div class="columns six box">
			<img src="/images/features/home_1.jpg" class="image"/>
		...
		<div class="columns six box">
			<img src="/images/features/home_2.jpg" class="image">
			...
			<a href="menu.php#entrees" class="special">See our menu</a>
		</div>
	</div>
</div>
<?php
